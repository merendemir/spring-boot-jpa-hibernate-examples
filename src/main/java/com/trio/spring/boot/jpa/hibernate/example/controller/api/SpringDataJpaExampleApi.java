...
@Tag(name = "Spring Data JPA", description = "CRUD operations using Spring Data JPA Repository")
public interface SpringDataJpaExampleApi {

    @Operation(
            summary = "Get all users",
            description = "Retrieves all users from database using Spring Data JPA Repository"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Retrieves a user by specified ID using Spring Data JPA Repository"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Creates a new user in database using Spring Data JPA Repository"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            summary = "Update user",
            description = "Updates existing user information using Spring Data JPA Repository"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            summary = "Delete user",
            description = "Deletes user with specified ID using Spring Data JPA Repository"
    )
    @ApiResponse(
            responseCode = "204",
